...
#
#     ./ocr.py <path-to-image-directory>
#
...
class VisionApi:
    ...
    def __init__(self, api_discovery_file='vision.json'):
        os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = api_discovery_file
...
def extract_descriptions(input_filename, index, texts):
    ...
    if texts:
        ...
        print("Image File: %s" % (input_filename.split("/")[-1]))
        print("Recognized Document Content:\n %s" % (document))
